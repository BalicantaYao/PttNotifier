...
from subscriptions.views import home, contact, privacy, terms_and_condictions, subscription_list, subscription_create, subscription_detail, subscription_update, subscription_delete, subscription_delete_confirm
