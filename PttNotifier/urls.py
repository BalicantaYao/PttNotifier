...
from subscriptions.views import home, subscription_list, subscription_create, subscription_detail, subscription_insert
...
urlpatterns = patterns('',
    ...
    url(r'^insert/$', subscription_insert, name='subscription_insert'),
